...
function drawComparisonChart(monthlyData) {
    ...
    comparisonChart = new Chart(ctx, {
        ...
        options: {
            responsive: true,
            // ASPECT RATIO FIX: Set to 1 for better display on small screens
            aspectRatio: 1, 
            interaction: {
                mode: 'index',
                intersect: false,
            ...
            scales: {
                x: {
                    // Only Income/Expense are stacked, Net is separated
                    stacked: true, 
                ...
                y: {
                    stacked: true, // This applies to all datasets without a specific stack group
                    beginAtZero: false,
            ...
            plugins: {
                ...
                title: {
                    ...
                    color: 'white',
                    font: { size: 14, weight: 'bold' } // Smaller font size for main title
                },
                tooltip: {
                    callbacks: {
                        label: function(context) {
