...
router.get('/:ticker', async (req, res) => {
    ...
    // *** CRITICAL FIX FOR ATH 404 ERROR ***
    // Replacing the failing /timeseries/daily?ticker= structure with the more common and reliable /api/v3/actions/list-prices/daily?ticker=
    const priceHistoryUrl = `https://backend.simfin.com/api/v3/actions/list-prices/daily?ticker=${ticker}`; 
    ...
    try {
        ...
        // --- 1. NET ASSETS (Balance Sheet) CALCULATION ---
        ...
        if (bsDefinition) {
            ...
            // Get the absolute latest filing (Q or FY) - CORE FIX FOR NET ASSETS
