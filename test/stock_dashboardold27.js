...
async function fetchStockData(ticker) {
    ...
    // *** START: NEW P/NET ASSETS CALCULATION (MODIFIED TO INVERTED PERCENTAGE: NA/MC) ***
    ...
    if (isNumber(rawMarketCapNum) && rawMarketCapNum !== 0 && netAssetsStr !== "N/A") {
        ...
        if (match) {
            ...
            if (isNumber(netAssetsValue)) {
                // Calculation changed to (Net Assets / Market Cap) * 100
                priceToNetAssets = (netAssetsValue / rawMarketCapNum * 100).toFixed(2) + "%";
            }
        }
    }
