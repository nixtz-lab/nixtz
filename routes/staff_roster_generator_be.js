 ...
 * SIMPLIFIED: Removes complex duty rotation and detailed role tracking logic for stability.
 */
const SHIFTS = { 
...
function generateWeeklyRoster(staffProfiles, weekStartDate) {
    ...
    DAYS_FULL.forEach((day, dayIndex) => {
        ...
        if (manager) {
            ...
            // CRITICAL CHECK: Skip if Pae is already scheduled (Day Off/Leave)
        ...
        // Re-filter staff who were not assigned Night shift
