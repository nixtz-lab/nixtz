...
// --- START: NEW WATCHLIST FUNCTION (COPIED FROM stock_dashboard.js) ---
...
function calculateValuation() {
    ...
    // *** NEW: Add smooth scroll to the results ***
    // We add a tiny delay to ensure the element is fully rendered before scrolling
    setTimeout(() => {
